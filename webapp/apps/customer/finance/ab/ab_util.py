...
from webapp.apps.customer.finance.models import AgriculturalBankOriginalKey, AgriculturalBankEncKey
...
if platform.system() in ['Windows']:
    ...
    so_path = os.path.join(webapp.settings.BASE_DIR, 'ab_crypt.so')
