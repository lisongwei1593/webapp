    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.FloatField(default=0, max_length=15, null=True, verbose_name='\u7eac\u5ea6', blank=True)),
                ('lng', models.FloatField(default=0, max_length=15, null=True, verbose_name='\u7ecf\u5ea6', blank=True)),
            ],
            options={
                'verbose_name': '\u57ce\u5e02',
