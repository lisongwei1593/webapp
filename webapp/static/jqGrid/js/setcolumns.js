    ...
    setColumns : function(p) {
        ...
        return this.each(function(){
            ...
            if ( $("#"+IDs.themodal).html() != null ) {
                ...
                bSel ="<a href='javascript:void(0)' id='selData' class='fm-button ui-state-default ui-corner-all'>"+p.bSelAll+"</a>";
                bCan ="<a href='javascript:void(0)' id='cancelData' class='fm-button ui-state-default ui-corner-all'>"+p.bCanAll+"</a>";
                formdata += "<table border='0' class='EditTable' id='"+dtbl+"_2'><tbody><tr style='display:block;height:3px;'><td></td></tr><tr><td class='DataTD ui-widget-content'></td></tr><tr><td class='ColButton EditButton'>"+bSel+"&#160;"+bCan+"&#160;"+bS+"&#160;"+bC+"</td></tr></tbody></table>";
                p.gbox = "#gbox_"+gID;
                ...
                $("#selData").click(function(e){
                    $("#"+IDs.modalcontent).find(":checkbox").attr("checked","checked");
                    return false;
                });
                $("#cancelData").click(function(e){
                    $("#"+IDs.modalcontent).find(":checkbox").removeAttr("checked");
                    return false;
                });
                $("#dData, #eData, #selData, #cancelData","#"+dtbl+"_2").hover(
